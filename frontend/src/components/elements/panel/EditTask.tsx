...
export const EditTask = (props: Props) => {
  ...
  const [defaultProject, setDefaultProject] = useState<Object>({});
  const [defaultStage, setDefaultStage] = useState<Object>({});
  const [defaultUser, setDefaultUser] = useState<Object>({});
