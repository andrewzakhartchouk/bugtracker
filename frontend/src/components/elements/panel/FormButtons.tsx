  ...
  return (
    <div className="flex flex-col gap-3 absolute left-2 text-white">
      <div className="flex group">
        <button
          className="relative rounded-full bg-main-green p-2 cursor-pointer transition hover:bg-white hover:text-main-green"
      ...
      <div className="flex group">
        <button
          className="relative rounded-full bg-main-red p-2 cursor-pointer transition hover:bg-white hover:text-main-red"
